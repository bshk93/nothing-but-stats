...
check_start_date <- "2024-11-06" # Date to start doing checks (newly entered data)
drop_after_date <- "2024-11-06" # Date after which to delete stats (e.g. unfinished days)
